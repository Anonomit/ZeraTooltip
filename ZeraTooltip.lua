...
function ZeraTooltip:CreateOptions()
  local addonOptions = {
    ...
    args = {
      simplify = {
        name = "Reword tooltips",
        desc = "Shortens some long lines of text on tooltips. Does not remove any information.",
        order = 100,
        type = "toggle",
      ...
      reorder = {
        name = "Reorder item stats",
        desc = "Makes tooltips display stats in a consistent order. Always Stamina before Intellect, for example.",
        order = 101,
        type = "toggle",
      ...
      recolor = {
        name = "Recolor lines",
        desc = "Adds coloring to some lines in tooltips.",
        order = 102,
        type = "toggle",
