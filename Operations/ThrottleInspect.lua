...
local function Throttle()
  Addon:DebugIfOutput("throttlingStarted", "Inspect throttler loaded")
...
Addon:RegisterAddonEventCallback("ENABLE", function(self) Addon:OnAddonLoad("Blizzard_InspectUI", Throttle) end)