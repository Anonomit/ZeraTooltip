...
function Addon:AddStackSize(tooltipData)
  ...
  self:AddExtraLine(tooltipData, self:GetOption("doReorder", stat) and tooltipData.title or tooltipData.itemLevel, self:RewordStackSize(format(coveredText .. ": %d", stackSize)), color)
end
