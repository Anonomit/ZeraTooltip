...
local contexts = Addon:MakeLookupTable(Addon:Squish{
  ...
  "Type",
  "RedType",
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.cata, "Reforged", nil),
  "Damage",
  "DamageBonus",
  "DamagePerSecond",
  "Armor",
  ...
  "RequiredEnchant",
  "WeaponEnchant",
  Addon:Ternary(Addon.isSoD, "Rune", nil),
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.tbc, "Socket",             nil),
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.tbc, "RequiredSocket",     nil),
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.tbc, "LastSocket",         nil),
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.tbc, "LastRequiredSocket", nil),
  "ProposedEnchant",
  "EnchantHint",
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.tbc, "SocketBonus", nil),
  "Durability",
  "RequiredRaces",
  "RequiredClasses",
  "RequiredLevel",
  ...
  "Charges",
  "Embed",
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.wrath, "EnchantOnUse",         nil),
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.wrath, "RequiredEnchantOnUse", nil),
  "SetName",
  "SetPiece",
  "LastSetPiece",
  "SetBonus",
  ...
  "GiftFrom",
  "WrittenBy",
  Addon:Ternary(Addon.expansionLevel >= Addon.expansions.tbc, "SocketHint", nil),
  "Refundable",
  "SoulboundTradeable",
  "Delta",
  "RecipeMats",
