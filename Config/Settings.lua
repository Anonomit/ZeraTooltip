...
function Addon:MakeDefaultOptions()
  local default = {
    profile = {
      ...
      doReword = {
        ...
        Unique                      = false,
        UniqueLimit                 = false,
        UniqueCategoryLimit         = false,
        UniqueEquipped              = false,
        UniqueEquippedCategoryLimit = false,
        Armor                       = false,
        BonusArmor                  = false,
        Block                       = false,
        Enchant                     = false,
      ...
      icon = {
        ...
        Unique                      = "Interface\\Buttons\\UI-StopButton",
        UniqueLimit                 = "Interface\\Buttons\\UI-StopButton",
        UniqueCategoryLimit         = "Interface\\Buttons\\UI-StopButton",
        UniqueEquipped              = "Interface\\Buttons\\UI-StopButton",
        UniqueEquippedCategoryLimit = "Interface\\Buttons\\UI-StopButton",
        Reforged                    = "Interface\\Reforging\\Reforge-Portrait",
  ...
  Addon.OverrideAllLocaleDefaults(default)
  return default
end
