...
if Addon.isEra then
  ...
  Addon:AddExtraStatCapture("Spell Power",
    ...
    {INPUT = "^Увеличивает урон и силу исцеления магических заклинаний и эффектов максимум на ([%d,]+) ед%.$"},
  ...
  Addon:AddExtraStatCapture("Hit Rating",
    ...
    {INPUT = "^Повышает вероятность попадания заклинаниями и атаками на ([%d,]+%%)%.$"})
  ...
  Addon:AddExtraStatCapture("Critical Strike Rating",
    ...
    {INPUT = "^Повышает вероятность критического эффекта всех атак и заклинаний на ([%d,]+%%)%.$"},
...
if Addon.isSoD or Addon.isTBC then
  Addon:AddExtraStatCapture("Healing",
    {INPUT = "^Увеличивает силу исцеления магических эффектов и заклинаний максимум на ([%d,]+) ед%., а наносимый ими урон – максимум на [%d,]+ ед%.$"})
end
