...
table.insert(L.INPUT,  "Increases your block rating by (%d+)%.?")
table.insert(L.OUTPUT, "+%d Block Rating")

table.insert(L.LABEL,  "ShieldBlockRating")
table.insert(L.INPUT,  "Increases your shield block rating by (%d+)%.?")
table.insert(L.OUTPUT, "+%d Block Rating")
...
table.insert(L.LABEL,  "ExtraAbilityDamage")
table.insert(L.INPUT,  "Adds (%d+) (.+) damage to your melee attacks%.?")
table.insert(L.OUTPUT, "+%d melee %s damage")
...
table.insert(L.OUTPUT, function(spell, amount) return ("+%s damage with %s"):format(amount:gsub("%%", "%%%%"), TrimSpell(spell)) end)
...
table.insert(L.OUTPUT, function(spell, amount) return ("+%s healing with %s"):format(amount:gsub("%%", "%%%%"), TrimSpell(spell)) end)
...
table.insert(L.INPUT,  "Decreases ?t?h?e? threat generated by ?y?o?u?r? (.*) by ([%d%.]*%d+%%?)")
table.insert(L.OUTPUT, function(spell, amount) return ("-%s threat from %s"):format(amount:gsub("%%", "%%%%"), spell) end)
...
table.insert(L.LABEL,  "ReduceThreat")
table.insert(L.INPUT,  "Reduces ?t?h?e? threat generated by ?y?o?u?r? (.*) by ([%d%.]*%d+%%?)")
table.insert(L.OUTPUT, function(spell, amount) return ("-%s threat from %s"):format(amount:gsub("%%", "%%%%"), spell) end)
...
table.insert(L.OUTPUT, function(resource, spell, amount) return ("+%s %s from %s"):format(amount:gsub("%%", "%%%%"), resource, TrimSpell(spell)) end)
